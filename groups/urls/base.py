...
urlpatterns = [
    ...
    # Group CRUD
    # ============================================================
    path("", GroupCRUDView.as_view(), name="group-list-create"),
    path("<int:id>/", GroupCRUDView.as_view(), name="group-detail"),
    # ============================================================
    # Group Members CRUD
    # ============================================================
    path(
    ...
    path("stats/overall/", GroupOverallStatsView.as_view(), name="group-overall-stats"),
]
