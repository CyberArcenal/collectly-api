...
class Login2FAInitDataSerializer(serializers.Serializer):
...
class Verify2FASuccessDataSerializer(serializers.Serializer):
...
class Resend2FASuccessDataSerializer(serializers.Serializer):
...
class LoginView(APIView):
    ...
    @extend_schema(
        ...
        responses={
            ...
            200: Login2FAInitResponseSerializer,  # Note: different structure but same status
