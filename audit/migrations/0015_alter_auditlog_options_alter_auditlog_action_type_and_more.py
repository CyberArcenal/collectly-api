# Generated by Django 5.2.3 on 2026-07-19 05:26
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("audit", "0014_alter_auditlog_action_type"),
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name="auditlog",
            index=models.Index(
                fields=["model_name"], name="audit_logs_model_n_da6855_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="auditlog",
        ...
        migrations.AddIndex(
            model_name="auditlog",
            index=models.Index(
                fields=["event_id"], name="audit_logs_event_i_fe7e9a_idx"
            ),
        ),
